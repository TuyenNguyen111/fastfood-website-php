...
<div class="container">
    <h1 class="text-center text-info">Thêm đơn hàng</h1>
    <form action="Create.php" method="post" class="col-7 form-control p-5" enctype="multipart/form-data"">
        <div class="row py-3">
            <label class="col-2">ID</label>
            <input class="col-2 p-1 me-4" placeholder="ID" value="<?php echo generateProductCode($ma) ?>" id="madon" name="madon" readonly />
             <label class="col-2">Mã khách hàng</label>
            <input class="col-5 p-1" type="text" placeholder="Tên sản phẩm" id="tenkhachhang" name="tenkhachhang" />
        ...
        <div class="row py-3">
            ...
            <label class="col-2" for="Status">Phương thức thanh toán</label>
