...
<h1 class="text-success text-center m-4 fw-bold">Thông tin đơn hàng</h1>
...
<!-- <form class="d-flex justify-content-center my-3 me-3" action="Index1.php"  method="post">
    ...
    if ($conn) {
        ...
        $querySeDH="select * from donhang where MaKH='$makh'";
        ...
        if ($SP) {
            ...
            if ($SP->rowCount() > 0) {
                ...
                <div>
                    ...
                    <tbody>
                          <?php foreach ($resultSeDH as $rowSeDH): ?>
                        <tr>
                            ...
                            <td><a href="Index1.php?id=<?php echo $rowSeDH["MaDon"]?>" class="btn btn-success">Xem</a></td>
                        </tr>
                         <?php $stt++; endforeach; ?>
                    </tbody>
                    </table>
                </div>
                <h2 class="fw-bold text-center text-success mt-5">Chi tiết đơn hàng</h2>
                <table class="table table-striped table-bordered">
                <thead class="thead-dark">
                    <tr>
                        <th>STT</th>
                ...
                <div class="d-flex flex-wrap justify-content-center">
                    <?php foreach ($resultSeCTDH as $rowSeCTDH): 
                    	...
                    	<tr>     
            					...
            					<td style="width:5%"><a class="btn btn-danger text-white" href="#">Hủy</a></td>
                			</tr>
